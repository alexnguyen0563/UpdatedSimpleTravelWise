    ...
    if (window.DotMetricsInitScript == undefined) {
        ...
        function start(hasConsent){
            ...
            var doorUrl = 'http%3a%2f%2fuk-script.dotmetrics.net%2fdoor.js%3fd%3dwww.timeout.com%26t%3dother';
            ...
            if(!hitDone){
                var dcOpt='';
                var imgUrl = 'https://uk-script.dotmetrics.net/hit.gif?id=6113&url=' + pageUrl + '&dom=' + domain + '&r=' + rand + '&pvs=' + pvs + '&pvid=' + pvid + dcOpt + '&c=' + hasConsent + '&tzOffset=' + tzOffset + '&doorUrl=' + doorUrl;
                        ...
                        window.DotMetricsSettings =
                                    {
                                        ...
                                        ScriptUrl:  'https://uk-script.dotmetrics.net/Scripts/script.js?v=245',
                                        ScriptDebugUrl:  'https://download.dotmetrics.net/Script/script.debug.js?v=2d9589b0-9ada-40f4-9983-4bc7b57060d4',
                                        PingUrl: 'https://uk-script.dotmetrics.net/Ping.dotmetrics',
                                        AjaxEventUrl: 'https://uk-script.dotmetrics.net/AjaxEvent.dotmetrics',
                                        NCSScriptUrl: 'https://uk-script.dotmetrics.net/Scripts/ncs-script.js?v=245',
                                        NCSScriptDebugUrl: 'https://download.dotmetrics.net/Script/ncs-script.debug.js?v=bbaba985-e269-48ea-8dc0-6c5b13ac0862',
                                        ...
                                        AdexEnabled: false,
                                        AdexConfigUrl: 'https://script.api/DotMetrics.Script.Adex/adexConfig.js?v=245&id=6113',
    ...
    function getDomainCookie(hasConsent){
        var ndc='77f81b9a-1e11-49cf-9786-80be23bc8206';
